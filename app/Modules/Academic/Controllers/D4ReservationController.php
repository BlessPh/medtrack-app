...
class D4ReservationController
{
    ...
    public function requests(Request $request): JsonResponse
    {
        ...
        return response()->json([
            'data' => CampaignHospital::query()->where('hospital_id', $hospital->id)->whereHas('campaign', fn ($query) => $query->where('strategy', 'D4_RESERVATION'))->with(['campaign.academicYear', 'campaign.promotions.level', 'campaign.media', 'media'])->latest('requested_at')->get()]);
    }
