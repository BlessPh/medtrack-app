...
class OpenApiGenerator
{
    ...
    private function queries(): array
    {
        return [
            ...
            'GET /api/v1/academic/campaigns' => ['university_id' => 'uuid', 'status' => '?enum:DRAFT|HOSPITAL_REQUESTS|OPEN|CLOSED|CANCELLED', 'academic_year_id' => '?integer'],
            'GET /api/v1/academic/campaign-requests' => ['hospital_id' => 'uuid'],
            'GET /api/v1/academic/campaign-reservations' => ['hospital_id' => 'uuid', 'status' => '?enum:RESERVED|ACCEPTED|CANCELLED', 'per_page' => '?integer'],
            'GET /api/v1/admissions/hospital-admissions' => ['hospital_id' => 'uuid'],
            ...
            'GET /api/v1/finance/dashboard' => ['institution_id' => 'uuid', 'date_from' => '?date', 'date_to' => '?date', 'university_id' => '?uuid', 'campaign_id' => '?uuid', 'currency' => '?string'],
            'GET /api/v1/finance/context' => ['institution_id' => 'uuid'],
            'GET /api/v1/finance/obligations' => ['institution_id' => 'uuid', 'status' => '?string', 'search' => '?string', 'date_from' => '?date', 'date_to' => '?date', 'university_id' => '?uuid', 'campaign_id' => '?uuid', 'currency' => '?string', 'per_page' => '?integer'],
            'GET /api/v1/finance/transactions' => ['institution_id' => 'uuid', 'status' => '?string', 'search' => '?string', 'date_from' => '?date', 'date_to' => '?date', 'university_id' => '?uuid', 'campaign_id' => '?uuid', 'currency' => '?string', 'per_page' => '?integer'],
            'GET /api/v1/finance/refunds' => ['institution_id' => 'uuid', 'status' => '?string', 'date_from' => '?date', 'date_to' => '?date', 'per_page' => '?integer'],
            'GET /api/v1/finance/reports/export' => ['institution_id' => 'uuid', 'status' => '?string', 'search' => '?string', 'date_from' => '?date', 'date_to' => '?date', 'university_id' => '?uuid', 'campaign_id' => '?uuid', 'currency' => '?string'],
    ...
    private function payloads(): array
    {
        return [
            ...
            'PUT /api/v1/institutions/{institution}' => array_diff_key($this->institutionPayload(), ['type' => true]),
            ...
            'POST /api/v1/institutions/{institution}/members' => ['email' => 'email', 'roles' => 'array:InstitutionRole'],
            'PUT /api/v1/institutions/{institution}/members/{user}' => ['roles' => 'array:InstitutionRole'],
            'PATCH /api/v1/institutions/{institution}/members/{user}/status' => ['status' => 'enum:ACTIVE|SUSPENDED', 'reason' => '?string'],
            'POST /api/v1/institutions/{institution}/member-invitations' => ['email' => 'email', 'roles' => 'array:InstitutionRole'],
            'POST /api/v1/institutions/{institution}/notifications' => ['title' => 'string', 'message' => 'string', 'severity' => '?enum:INFO|SUCCESS|WARNING|CRITICAL', 'url' => '?string', 'role' => '?enum:INSTITUTION_ADMIN|ACADEMIC_MANAGER|HOSPITAL_MANAGER|SUPERVISOR|FINANCE_OFFICER|MEMBER', 'service_id' => '?integer'],
            'PUT /api/v1/institutions/{institution}/supervisors/{user}' => ['service_ids' => 'array:IntegerListItem', 'availability_status' => 'enum:AVAILABLE|LIMITED|UNAVAILABLE', 'availability_note' => '?string', 'stages_enabled' => 'boolean'],
            ...
            'POST /api/v1/finance/manual-payments' => ['institution_id' => 'uuid', 'obligation_id' => 'uuid', 'amount' => 'number', 'currency' => 'string', 'method' => 'string', 'payer_reference' => 'string', 'paid_at' => 'date', 'notes' => '?string'],
            'POST /api/v1/finance/transactions/{transaction}/allocations' => ['obligation_id' => 'uuid', 'amount' => 'number'],
            ...
            'PATCH /api/v1/admissions/applications/{application}/hospital-decision' => ['decision' => 'enum:PENDING|ACCEPTED|REJECTED', 'service_id' => '?integer', 'starts_on' => '?date', 'ends_on' => '?date', 'internal_note' => '?string'],
            ...
            'PUT /api/v1/internships/{internship}' => ['supervisor_id' => '?uuid', 'path_template_id' => '?integer', 'starts_on' => 'date', 'ends_on' => '?date'],
            'POST /api/v1/internships/{internship}/notifications' => ['title' => 'string', 'message' => 'string', 'recipients' => 'enum:STUDENT|SUPERVISOR|BOTH'],
            'POST /api/v1/internships/{internship}/supervisor-observations' => ['content' => 'string'],
            'PATCH /api/v1/internships/supervisor/availability' => ['availability_status' => 'enum:AVAILABLE|LIMITED|UNAVAILABLE', 'availability_note' => '?string', 'stages_enabled' => 'boolean'],
            ...
            'POST /api/v1/scheduling/attendance' => ['student_id' => 'uuid', 'schedule_entry_id' => '?integer', 'type' => 'enum:CHECK_IN|CHECK_OUT|ABSENCE|LATE', 'recorded_at' => 'datetime', 'source' => 'enum:MANUAL|BIOMETRIC', 'device_code' => '?string', 'notes' => '?string'],
            ...
            'POST /api/v1/assessments/evaluations' => ['rotation_id' => 'integer', 'template_id' => 'integer', 'answers' => 'object', 'comments' => '?string'],
            ...
            'POST /api/v1/finance/obligations' => ['student_id' => 'uuid', 'institution_id' => 'uuid', 'campaign_id' => '?uuid', 'type' => 'string', 'description' => 'string', 'currency' => 'string', 'due_date' => '?date', 'items' => 'array:FinancialItem'],
    ...
    private function schemas(): array
    {
        return [
            ...
            'FinancialObligationItem' => ['type' => 'object', 'required' => ['label', 'quantity', 'unit_amount'], 'properties' => ['label' => ['type' => 'string'], 'quantity' => ['type' => 'number', 'minimum' => 0.01], 'unit_amount' => ['type' => 'number', 'minimum' => 0]]],
